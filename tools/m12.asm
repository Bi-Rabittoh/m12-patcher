...
// MODIFICA L'ASPETTO DELLA CARTUCCIA DI MOTHER 2
// org $86E3B94; incbin m12_gfx_whichgame_m2.bin [ATTUALMENTE NON FUNZIONANTE]
...
// FINESTRA "Vuoi sovrascriverlo?"
org $8FE7EE0; incbin m1_window_file_menu_4.bin
org $8F0D380; dd $8FE7EE0
...
org $8F27770; db $0B   // move enemy name box left a little bit
org $8F27776; db $11   // expand enemy name box in battle
org $8F2777F; db $11
org $8F27788; db $11
org $8F27791; db $11
org $8F2779A; db $11
org $8F277A3; db $11
org $8F10F32; db $0C   // move cursor
...
// INVERTE LA POSIZIONE DEI CONTANTI E DEL SIMBOLO DEL DOLLARO NELLA FINESTRA DEL PORTAFOGLI
org $8F0B03C; dd $8FE4400
org $8FE4400; incbin m1_window_money.bin

// ALLARGA LA FINESTRA DI SCELTA DEL NOME DEL GIOCATORE DI 1 TILE A DESTRA
org $8F0BCD8; dd $8FE4430
org $8FE4430; incbin m1_window_naming_player.bin
...
// SPOSTA IL SIMBOLO DEL DOLLARO NEI NEGOZI DOPO IL PREZZO [MERITO DI LORENZOOONE]
org $8F0BAD8;
bl change_dollar_sign_pos_shop;
nop;
nop;
nop;
nop
...
org $8F633BC; incbin m1_gfx_produced_by_a.bin
org $8F633EC; incbin m1_gfx_produced_by_b.bin
org $8F0D5D0; bl producescreen1; b $8F0D5E8
org $8F634EC; incbin m1_gfx_presents.bin
...
// INIETTA LA MAPPA CON SCRITTO "CASA" AL POSTO DI "MY HOME"
